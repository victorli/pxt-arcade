namespace config {
    ...
    export const PIN_BTN_A = DAL.P0_9
    export const PIN_BTN_B = DAL.P0_23

    export const PIN_BTN_MENU = DAL.P0_14

    export const PIN_BTN_RIGHT = DAL.P0_4
    export const PIN_BTN_LEFT = DAL.P1_0
    export const PIN_BTN_UP = DAL.P0_12
    export const PIN_BTN_DOWN = DAL.P0_26

    export const PIN_DISPLAY_SCK = DAL.P0_17 // yellow
    export const PIN_DISPLAY_MOSI = DAL.P0_13 // green
    export const PIN_DISPLAY_RST = DAL.P0_1 // purple
    export const PIN_DISPLAY_DC = DAL.P1_2 // blue
